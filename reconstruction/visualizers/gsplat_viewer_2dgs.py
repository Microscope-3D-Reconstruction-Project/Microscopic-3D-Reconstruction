...
class GsplatRenderTabState2D(RenderTabState):
    ...
    render_mode: Literal[
        "rgb", "depth(accumulated)", "depth(expected)", "alpha", "normal"
    ] = "rgb"
...
class GsplatViewer2D(Viewer):
    ...
    def _init_rendering_tab(self):
        self.render_tab_state = GsplatRenderTabState2D()
    ...
    def _populate_rendering_tab(self):
        ...
        with self._rendering_folder:
            with server.gui.add_folder("Gsplat 2D"):
